...
console.log("NETLIST AMMETERS:", netlist.physical_stage.ammeters);
...
sim.runAsync(() => false, () => false).then(results => {
    console.log("Available Signals:", Object.keys(results.signals));
    console.log("AM_R1 signal values (first 5):", results.signals["AM_R1.Out"]?.slice(0, 5));
});
